...
import com.github.ptube.helpers.LocaleHelper.getDetectedCountry
...
object PreferenceHelper {
    ...
    private val MIGRATIONS = arrayOf(
        ...
        PreferenceMigration(1, 2) {
            ...
            putString(PreferenceKeys.TRENDING_CATEGORY, TrendingCategory.ALL.name)
        },
        PreferenceMigration(2, 3) {
            // git log -p -- app/src/main/java/com.github.ptube/constants/PreferenceKeys.kt | rg "^-.*const val [A-Z_]+" | awk '{printf("%s,", $6);}' | sort | uniq
            listOf(
                "player_audio_format",
                "lbry_hls",

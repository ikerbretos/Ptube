...
import com.github.ptube.api.obj.ChannelTab
...
import com.github.ptube.api.obj.MetaInfo
import com.github.ptube.api.obj.PipedStream
import com.github.ptube.api.obj.Playlist
import com.github.ptube.api.obj.PreviewFrames
...
import com.github.ptube.api.obj.StreamItem.Companion.TYPE_CHANNEL
import com.github.ptube.api.obj.StreamItem.Companion.TYPE_PLAYLIST
import com.github.ptube.api.obj.StreamItem.Companion.TYPE_STREAM
import com.github.ptube.api.obj.Streams
import com.github.ptube.api.obj.Subtitle
import com.github.ptube.api.poToken.PoTokenGenerator
import com.github.ptube.extensions.parallelMap
import com.github.ptube.extensions.sha256Sum
import com.github.ptube.extensions.toID
import com.github.ptube.helpers.NewPipeExtractorInstance
import com.github.ptube.helpers.PlayerHelper
import com.github.ptube.ui.dialogs.ShareDialog.Companion.YOUTUBE_FRONTEND_URL
...
class NewPipeMediaServiceRepository : MediaServiceRepository {
    ...
    private val trendingCategories = TrendingCategory.entries.filter { it != TrendingCategory.ALL }.associate {
        when (it) {
            ...
            TrendingCategory.ALL -> throw IllegalArgumentException()
        }
    }

    override fun getTrendingCategories(): List<TrendingCategory> =
        TrendingCategory.entries.toList()

    override suspend fun getTrending(region: String, category: TrendingCategory): List<StreamItem> {
        if (category == TrendingCategory.ALL) {
            return trendingCategories.keys.toList().parallelMap { cat ->
                runCatching { getTrending(region, cat) }.getOrDefault(emptyList())
            }.let { lists ->
                val result = mutableListOf<StreamItem>()
                var i = 0
                while (result.size < 50 && lists.any { i < it.size }) {
                    lists.forEach { list ->

package com.github.ptube.services
...
import com.github.ptube.PtubeApp.Companion.DOWNLOAD_CHANNEL_NAME
...
import com.github.ptube.enums.NotificationId
import com.github.ptube.extensions.TAG
import com.github.ptube.extensions.formatAsFileSize
import com.github.ptube.extensions.getContentLength
import com.github.ptube.extensions.parcelableExtra
import com.github.ptube.extensions.toLocalDate
import com.github.ptube.extensions.toastFromMainDispatcher
import com.github.ptube.extensions.toastFromMainThread
import com.github.ptube.helpers.DownloadHelper
import com.github.ptube.helpers.DownloadHelper.getNotificationId
...
import com.github.ptube.obj.DownloadStatus
import com.github.ptube.parcelable.DownloadData
import com.github.ptube.receivers.NotificationReceiver
import com.github.ptube.receivers.NotificationReceiver.Companion.ACTION_DOWNLOAD_PAUSE
import com.github.ptube.receivers.NotificationReceiver.Companion.ACTION_DOWNLOAD_RESUME
import com.github.ptube.receivers.NotificationReceiver.Companion.ACTION_DOWNLOAD_STOP
...
class DownloadService : LifecycleService() {
    ...
    companion object {
        ...
        const val ACTION_SERVICE_STARTED =
            "com.github.ptube.services.DownloadService.ACTION_SERVICE_STARTED"
        const val ACTION_SERVICE_STOPPED =
            "com.github.ptube.services.DownloadService.ACTION_SERVICE_STOPPED"

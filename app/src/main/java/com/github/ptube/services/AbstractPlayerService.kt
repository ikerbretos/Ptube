...
import com.github.ptube.extensions.updateParameters
import com.github.ptube.helpers.PlayerHelper
import com.github.ptube.helpers.PlayerHelper.getSubtitleRoleFlags
import com.github.ptube.ui.activities.MainActivity
import com.github.ptube.util.DefaultTrackSelectorWithAudioQualitySupport
import com.github.ptube.util.NowPlayingNotification
import com.github.ptube.util.PauseableTimer
...
abstract class AbstractPlayerService : MediaLibraryService(), MediaLibrarySession.Callback {
    ...
    private fun createPlayerAndMediaSession() {
        ...
        // prevent android from putting PTUBE to sleep when locked

...
class GeneralSettings : BasePreferenceFragment() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        val regionPreference = findPreference<Preference>(PreferenceKeys.REGION)
        regionPreference?.setOnPreferenceClickListener {
            com.github.ptube.ui.fragments.TrendsFragment.showChangeRegionDialog(requireContext()) {}
            true
        }

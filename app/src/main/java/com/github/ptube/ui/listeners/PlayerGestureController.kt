package com.github.ptube.ui.listeners
...
class PlayerGestureController(activity: BaseActivity, private val listener: PlayerGestureOptions) {
    ...
    fun onTouchEvent(event: MotionEvent): Boolean {
        ...
        val gestureResult = if (!scaleGestureWasInProgress) gestureDetector.onTouchEvent(event) else false
        
        if (isShortsMode) return gestureResult
        return true
    }

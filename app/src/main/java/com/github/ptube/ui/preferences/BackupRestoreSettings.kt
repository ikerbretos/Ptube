...
import com.github.ptube.databinding.DialogImportExportFormatChooserBinding
import com.github.ptube.enums.ImportFormat
import com.github.ptube.helpers.BackupHelper
import com.github.ptube.helpers.ImportHelper
import com.github.ptube.helpers.PreferenceHelper
import com.github.ptube.obj.BackupFile
import com.github.ptube.ui.base.BasePreferenceFragment
import com.github.ptube.ui.dialogs.BackupDialog
import com.github.ptube.ui.dialogs.BackupDialog.Companion.BACKUP_DIALOG_REQUEST_KEY
...
class BackupRestoreSettings : BasePreferenceFragment() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        childFragmentManager.setFragmentResultListener(
            ...
            createBackupFile.launch("PTUBE-backup-${timestamp}.json")
        }

...
import com.github.ptube.databinding.CustomExoPlayerViewTemplateBinding
import com.github.ptube.databinding.DoubleTapOverlayBinding
import com.github.ptube.databinding.ExoStyledPlayerControlViewBinding
import com.github.ptube.databinding.PlayerGestureControlsViewBinding
import com.github.ptube.extensions.dpToPx
import com.github.ptube.extensions.navigateVideo
import com.github.ptube.extensions.normalize
import com.github.ptube.extensions.round
import com.github.ptube.extensions.seekBy
import com.github.ptube.extensions.togglePlayPauseState
import com.github.ptube.extensions.updateIfChanged
import com.github.ptube.helpers.AudioHelper
import com.github.ptube.helpers.BrightnessHelper
...
import com.github.ptube.ui.controllers.FullscreenGestureAnimationController
import com.github.ptube.ui.extensions.toggleSystemBars
import com.github.ptube.ui.fragments.PlayerFragment
import com.github.ptube.ui.interfaces.PlayerGestureOptions
import com.github.ptube.ui.interfaces.PlayerOptions
import com.github.ptube.ui.listeners.PlayerGestureController
import com.github.ptube.ui.models.ChaptersViewModel
import com.github.ptube.ui.sheets.BaseBottomSheet
import com.github.ptube.ui.sheets.ChaptersBottomSheet
import com.github.ptube.ui.sheets.PlaybackOptionsSheet
import com.github.ptube.ui.sheets.PlayingQueueSheet
import com.github.ptube.ui.sheets.SleepTimerSheet
import com.github.ptube.ui.tools.SleepTimer
...
abstract class CustomExoPlayerView(
    ...
    var isShortsMode: Boolean = false
        set(value) {
            field = value
            playerGestureController.isShortsMode = value
        }
